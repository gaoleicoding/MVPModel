...
import com.gaolei.mvpmodel.base.thirdframe.retrofit.interceptor.DefaultHeaderInterceptor;
...
public final class RetrofitDynamicProvider {
    ...
    //在一个项目中可能会有不同host也就是不同的baseUrl，在这里可能动态设置baseUrl
...
//                    .addNetworkInterceptor(new ParamsEncryptInterceptor())//参数加密,一般针对表单中的字段和值进行加密，防止中途第三方进行窥探和篡改
        ...
        mRetrofit = new Retrofit.Builder()
                ...
                .baseUrl(BASE_URL)
                .addConverterFactory(CustomizeGsonConverterFactory.create())//自定义Converter.Factory，系统默认的是GsonConverterFactory
