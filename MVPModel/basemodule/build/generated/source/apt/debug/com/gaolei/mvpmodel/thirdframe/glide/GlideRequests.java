...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.gaolei.mvpmodel.thirdframe.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.gaolei.mvpmodel.thirdframe.glide.GlideOptions().apply(toSet));
    }
  }
}
